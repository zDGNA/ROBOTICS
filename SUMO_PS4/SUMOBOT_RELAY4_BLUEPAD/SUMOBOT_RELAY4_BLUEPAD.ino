...
const uint8_t targetMacAddress[] = {0xC0, 0xDC, 0xFB, 0x3F, 0x00, 0x00};
ControllerPtr myControllers[BP32_MAX_GAMEPADS];
ControllerPtr connectedController = nullptr;

// Definisi pin relay motor
#define relay1 13  // Motor 1 Forward
#define relay2 12  // Motor 1 Backward
#define relay3 14  // Motor 2 Forward
#define relay4 27  // Motor 2 Backward
...
void moveBackward() {
    digitalWrite(relay1, HIGH);
    digitalWrite(relay2, LOW); /// 2 KE 5
    digitalWrite(relay3, HIGH);
...
void initializeRelays() {
    ...
    // digitalWrite(relay7, HIGH);
    // digitalWrite(relay8, HIGH);
    delay(50);  // Tunggu sebentar untuk memastikan semua relay mati
